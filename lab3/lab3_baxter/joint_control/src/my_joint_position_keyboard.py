...
def map_keyboard(side):
    ...
    while (limb.joint_angle(joints[0])-theta['right_s0']<0.1 or
            limb.joint_angle(joints[1])-theta['right_s1']<0.1 or
            limb.joint_angle(joints[2])-theta['right_e0']<0.1 or
            limb.joint_angle(joints[3])-theta['right_e1']<0.1 or
            limb.joint_angle(joints[4])-theta['right_w0']<0.1 or
            limb.joint_angle(joints[5])-theta['right_w1']<0.1 or
            limb.joint_angle(joints[6])-theta['right_w2']<0.1):
