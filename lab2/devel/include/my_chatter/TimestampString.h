...
// {'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'my_chatter': ['/home/cc/ee106a/fa18/class/ee106a-aem/ros_workspaces/lab2/src/my_chatter/msg']}
...
struct MD5Sum< ::my_chatter::TimestampString_<ContainerAllocator> >
{
  ...
  {
    return "ea60f95b56d48cb2880c573ef9019cdc";
  }

  static const char* value(const ::my_chatter::TimestampString_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xea60f95b56d48cb2ULL;
  static const uint64_t static_value2 = 0x880c573ef9019cdcULL;
};
